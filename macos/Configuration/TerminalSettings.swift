...
public enum TerminalSettings {
    ...
    public static let unavailable: [String: String] = [
        ...
        "click-repeat-interval": "Needs mouse event forwarding and cursor/selection integration in TerminalView.",
        ...
        "link-osc8": "Needs pointer interaction and the open-URL callback.",
        "link-previews": "Needs link hover handling and a preview UI.",
        "link-url": "Needs pointer interaction and the open-URL callback.",
        ...
        "macos-option-as-alt": "Needs Option-aware key text translation, consumed modifiers, and left/right modifier tracking.",
        ...
        "mouse-hide-while-typing": "Needs mouse event forwarding and cursor/selection integration in TerminalView.",
        "mouse-reporting": "Needs mouse event forwarding and cursor/selection integration in TerminalView.",
        "mouse-scroll-multiplier": "Needs mouse event forwarding and cursor/selection integration in TerminalView.",
        "mouse-shift-capture": "Needs mouse event forwarding and cursor/selection integration in TerminalView.",
        ...
        "right-click-action": "Needs secondary-click handling and, for context-menu mode, an AppKit menu.",
        ...
        "selection-word-chars": "Needs mouse event forwarding and cursor/selection integration in TerminalView.",
